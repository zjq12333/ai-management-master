...
const rainbowButtonVariants = cva(
  cn(
    ...
    "rounded-[6px] outline-none focus-visible:ring-[3px] aria-invalid:border-destructive",
  ...
  ),
  {
    variants: {
      ...
      size: {
        default: "h-[33px] px-4 py-2",
        sm: "h-[29px] rounded-[6px] px-3 text-xs",
        lg: "h-[41px] rounded-[6px] px-8",
        icon: "size-[33px]",
      },
    },
    defaultVariants: {
